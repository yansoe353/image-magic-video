...
serve(async (req) => {
  ...
  try {
    ...
    console.log("Calling fal.ai ltx-animation API with input:", JSON.stringify(input));
    
    const response = await fetch('https://fal.ai/fal-ai/ltx-animation/run', {
      method: 'POST',
      headers: {
    ...
    console.log("Successfully generated video, response:", JSON.stringify(data));
